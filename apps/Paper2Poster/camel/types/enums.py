...
class ModelType(UnifiedModelType, Enum):
    ...
    QWEN_2_VL_7B = 'qwen2-vl-7b-instruct'
    QWEN_QWQ_32B = "qwq-32b-preview"
    ALIYUN_LLAMA4_SCOUT_17B_16E = 'llama-4-scout-17b-16e-instruct'
    ...
    def is_qwen(self) -> bool:
        return self in {
            ...
            ModelType.DEEPINFRA_QWEN_2_5_72B,
            ModelType.QWEN_2_5_VL_72B,
            ModelType.QWEN_2_VL_7B,
            ModelType.ALIYUN_LLAMA4_SCOUT_17B_16E
        }
...
class ModelPlatformType(Enum):
    ...
    def is_deepinfra(self) -> bool:
        r"""Returns whether this platform is DeepInfra."""
        return self is ModelPlatformType.DEEPINFRA
