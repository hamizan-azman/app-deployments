...
class Seqeval(evaluate.Metric):
    ...
    def _compute(
        ...
        overall_score_micro = report.pop("micro avg")
        ...
        scores["overall_precision_micro"] = overall_score_micro["precision"]
        scores["overall_recall_micro"] = overall_score_micro["recall"]
        scores["overall_f1_micro"] = overall_score_micro["f1-score"]
        scores["overall_precision_macro"] = overall_score["precision"]
        scores["overall_recall_macro"] = overall_score["recall"]
        scores["overall_f1_macro"] = overall_score["f1-score"]
